...
The number of requests with a max-age of 1.

### `maxage30`

The number of requests with a max-age of 30.

### `maxage365`

The number of requests with a max-age of 365.

### `maxageMore`

The number of requests with a max-age greater than 365.

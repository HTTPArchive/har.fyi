...
<Tabs>
  ...
  WITH requests AS (
    ...
    FROM
      `httparchive.crawl.requests` TABLESAMPLE SYSTEM (1 PERCENT)
    WHERE
      date = '2024-06-01'
      AND client = 'desktop'
      AND is_root_page
...
[`payload`](#payload) | [`Request payload`](/reference/structs/request-payload/) | JSON-encoded WebPageTest result data for this request
[`summary`](#summary) | [`Request summary`](/reference/structs/request-summary/) | JSON-encoded summarization of request data
...
See the [`payload`](/reference/structs/request-payload/) reference for more details.

### `summary`

JSON-encoded summarization of request data

See the [`summary`](/reference/structs/request-summary/) reference for more details.

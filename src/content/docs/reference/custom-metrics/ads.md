...
|-------------------------------------------|---------|-------------------------------------------------------------------------------------------------------|
| `ads`                                     | record  | Contains information about the ads.txt file.                                                          |
...
| `ads.account_types`                       | record  | Types of accounts (direct or reseller) listed in the ads.txt file.                                    |
| `ads.account_types.direct`                | record  | Information about direct advertising accounts.                                                        |
...
| `ads.account_types.reseller`              | record  | Information about reseller advertising accounts.                                                      |
...
| `app_ads`                                 | record  | Contains information about the app-ads.txt file.                                                      |
...
| `app_ads.account_types`                   | record  | Types of accounts (direct or reseller) listed in the app-ads.txt file.                                |
| `app_ads.account_types.direct`            | record  | Information about direct advertising accounts.                                                        |
...
| `app_ads.account_types.reseller`          | record  | Information about reseller advertising accounts.                                                      |
...
| `sellers`                                 | record  | Contains information about the sellers.json file.                                                     |
...
| `sellers.seller_types`                    | record  | Types of sellers (publisher, intermediary, both) listed in the sellers.json file.                     |
| `sellers.seller_types.publisher`          | record  | Information about publisher sellers.                                                                  |
...
| `sellers.seller_types.intermediary`       | record  | Information about intermediary sellers.                                                               |
...
| `sellers.seller_types.both`               | record  | Information about sellers who are both publishers and intermediaries.                                 |
